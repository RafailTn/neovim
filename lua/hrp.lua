...
-- And the best ones
vim.keymap.set("n", "<A-mn>", function() harpoon:list():next() end, {desc = "[N]ext harpoon listing" })
vim.keymap.set("n", "<A-mp>", function() harpoon:list():prev() end, {desc = "[P]revious harpoon listing" })
